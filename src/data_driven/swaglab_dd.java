...
public class swaglab_dd {
		...
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			driver.manage().window().maximize();
	         ...
	         FileInputStream excel=new FileInputStream("C:\\Users\\Asus\\Desktop\\excels\\swaglabs.xlsx");
			...
			{
			driver.findElement(By.xpath("//*[@id=\"user-name\"]")).sendKeys(sh.getRow(i).getCell(0).getStringCellValue());
			...
			FileOutputStream fout=new FileOutputStream("C:\\Users\\Asus\\Desktop\\excels\\swaglabs.xlsx");
			wb.write(fout);
